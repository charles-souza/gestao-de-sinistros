...
@RestController
@RequestMapping("/v1/consultants")
public class ConsultantController {

	private ConsultantService<Consultant> service;
	...
	public ConsultantController(ConsultantService<Consultant> service) {
		this.service = service;	
	}

	@PostMapping
	@ResponseStatus(HttpStatus.CREATED)
	public ReturnRequest create(@RequestBody @Valid ConsultantDTO dto) {		
	...
	@PutMapping("{id}")
	public ReturnRequest update(@Valid @PathVariable Long id, @RequestBody ConsultantDTO dto) {
		try {
